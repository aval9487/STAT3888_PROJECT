...
# Split data into Indigenous and NonIndigenous
indigenous_df <- filter(filtered_cvd_df, group == "Indigenous")
nonindigenous_df <- filter(filtered_cvd_df, group == "NonIndigenous")
...
All vars are significant -> save dataframe
```{r}
save(sig_biom_final, sorted_biom_p_df, biom_var_info,
       file = "biomAnalysisFinalp7.Rdata")
```
